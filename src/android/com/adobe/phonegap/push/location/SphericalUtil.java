 ...
 *
 * Copied from https://github.com/googlemaps/android-maps-utils/blob/master/library/src/com/google/maps/android/SphericalUtil.java
 */
...
public class SphericalUtil {
     ...
     *
     */
    public static boolean pointInCircle(LatLng point, LatLng center, double radius ) {
        double distance = computeDistanceBetween(point, center);
